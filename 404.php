        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <div class="post-entry-1 lg">
              <a href="single-post.html"><img src="<?php echo get_template_directory_uri().'/assets/img/post-landscape-1.jpg'?>" alt="" class="img-fluid"></a>
              ...
              <div class="d-flex align-items-center author">
                ...
                <div class="photo"><img src="<?php echo get_template_directory_uri().'/assets/img/person-1.jpg'?>" alt="" class="img-fluid"></div>
                <div class="name">
            ...
            <div class="row g-5">
              <div class="col-lg-4 border-start custom-border">
                ...
                <div class="post-entry-1">
                  <a href="single-post.html"><img src="<?php echo get_template_directory_uri().'/assets/img/post-landscape-2.jpg'?>" alt="" class="img-fluid"></a>
                  <div class="post-meta"><span class="date">Sport</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                  <h2><a href="single-post.html">Let’s Get Back to Work, New York</a></h2>
                </div>
                <div class="post-entry-1">
                  <a href="single-post.html"><img src="/602/wordpress/wp-content/themes/MYTHEME/assets/img/post-landscape-5.jpg" alt="" class="img-fluid"></a>
              ...
              <div class="col-lg-4 border-start custom-border">
                <div class="post-entry-1">
                  <a href="single-post.html"><img src="<?php echo get_template_directory_uri().'/assets/img/post-landscape-3.jpg'?>" alt="" class="img-fluid"></a>
                  <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                  <h2><a href="single-post.html">6 Easy Steps To Create Your Own Cute Merch For Instagram</a></h2>
                </div>
                <div class="post-entry-1">
                  <a href="single-post.html"><img src="<?php echo get_template_directory_uri().'/assets/img/post-landscape-6.jpg'?>" alt="" class="img-fluid"></a>
                  <div class="post-meta"><span class="date">Tech</span> <span class="mx-1">&bullet;</span> <span>Mar 1st '22</span></div>
                  <h2><a href="single-post.html">10 Life-Changing Hacks Every Working Mom Should Know</a></h2>
                </div>
                <div class="post-entry-1">
                  <a href="single-post.html"><img src="/602/wordpress/wp-content/themes/MYTHEME/assets/img/post-landscape-8.jpg" alt="" class="img-fluid"></a>
          ...
          <div class="col-md-9">
            ...
            <div class="d-lg-flex post-entry-2">
              <a href="single-post.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                <img src="/wp-content/themes/MYTHEME/assets/img/post-landscape-6.jpg" alt="" class="img-fluid">
              </a>
              <div>
                <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
